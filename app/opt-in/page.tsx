      ...
      <section className="flex flex-1 items-center justify-center py-24 px-6">
        <div className="max-w-md text-center">
          ...
          <p className="mt-4 text-gray-600">
            Thank you for opting in to receive SMS updates from JJ Johnson
            Health LLC. You&apos;ll receive a confirmation text shortly.
          </p>
          <p className="mt-4 text-sm text-gray-500">
            Reply STOP at any time to unsubscribe. Message and data rates may
            apply.
          </p>
        </div>
      </section>
    ...
    <section className="py-16 px-6">
      <div className="mx-auto max-w-lg">
        ...
        <p className="mt-4 text-center text-gray-600">
          Sign up to receive health insurance tips, open-enrollment reminders,
          and personalized quotes from JJ Johnson Health LLC via text message.
        </p>
          ...
          <div className="rounded-xl border border-gray-200 bg-gray-50 p-4">
            <label className="flex items-start gap-3 cursor-pointer">
              ...
              <span className="text-sm text-gray-700 leading-relaxed">
                ...
                consent to receive recurring marketing text messages (e.g.,
                health insurance quotes, open-enrollment reminders, and
                promotional offers) from <strong>JJ Johnson Health LLC</strong>{" "}
                at the phone number provided above. Message frequency varies.
